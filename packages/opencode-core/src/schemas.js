  ...
  return {
    ...
    remote: {
      ...
      telegram: {
        ...
        webhookSecret: readNullableString(input.remote?.telegram?.webhookSecret, defaults.remote.telegram.webhookSecret, 'remote.telegram.webhookSecret'),
      },
    },
...
function parseMemoryPolicy(value, defaults, fieldName) {
  ...
  return {
    compact: {
      ...
      contradictionMinSharedTerms: readInteger(compact.contradictionMinSharedTerms, defaults.compact.contradictionMinSharedTerms, `${fieldName}.compact.contradictionMinSharedTerms`, 1),
